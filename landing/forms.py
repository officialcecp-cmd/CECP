...
from .models import Project, ProjectCategory, ClubApplication, FacultyProfile, ClubMember
...
class FacultyProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'students_mentored': forms.NumberInput(attrs={'class': 'glass-input'}),
...
class ProjectSubmissionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'documentation_url': forms.URLInput(attrs={'class': 'form-input', 'placeholder': 'https://drive.google.com/...'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Make documentation URL required
        self.fields['documentation_url'].required = True
        self.fields['documentation_url'].help_text = 'Provide a Google Drive link to your documentation/paper/PPT (mandatory)'
    ...
    def clean_documentation_url(self):
        """Validate the documentation link."""
...
class UserProfileForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'hometown', 'mobile_number', 'github_profile', 'linkedin_profile', 'leetcode_profile',
            'quote', 'core_technologies', 'future_field', 'personal_interests',
            'professional_bio', 'career_goals'
        ]
        widgets = {
            ...
            'leetcode_profile': forms.URLInput(attrs={
                'class': 'w-full rounded-md bg-slate-900 p-3 text-white border border-slate-700 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500',
            ...
            'core_technologies': forms.TextInput(attrs={
                'class': 'w-full rounded-md bg-slate-900 p-3 text-white border border-slate-700 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500',
                'placeholder': 'e.g., Python, React, IoT'
            }),
            'future_field': forms.TextInput(attrs={
                'class': 'w-full rounded-md bg-slate-900 p-3 text-white border border-slate-700 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500',
                'placeholder': 'e.g., Robotics, AI Research'
            }),
            'personal_interests': forms.TextInput(attrs={
                'class': 'w-full rounded-md bg-slate-900 p-3 text-white border border-slate-700 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500',
                'placeholder': 'e.g., Playing Guitar, Sketching'
            }),
            ...
            'career_goals': forms.Textarea(attrs={
                'class': 'w-full rounded-md bg-slate-900 p-3 text-white border border-slate-700 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500',
                'placeholder': 'Your long-term ambitions...',
                'rows': 3
            }),
        }
